...
| Query used to locate events:                                                                                                                                                                                                                      |
|--------------------------------------------------------------------------------------------------------------------------------------------------|
| DeviceProcessEvents <br>\| where DeviceName == "threat-hunt-lab"<br>\|where ProcessCommandLine contains "tor-browser-windows-x86_64-portable-14.0.1.exe"<br>\| project Timestamp, DeviceName, AccountName, ActionType, FileName, FolderPath, SHA256, ProcessCommandLine<br>\| order by Timestamp desc

![image](https://github.com/user-attachments/assets/4f8ad349-6b7f-4007-95f6-5e3e47c3205a)
